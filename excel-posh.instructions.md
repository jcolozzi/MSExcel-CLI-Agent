...
This module provides 43 PowerShell functions for full Excel workbook automation via COM. Use `-AsJson` on any function for structured output. The `@excel-dev` agent has the complete function reference.
